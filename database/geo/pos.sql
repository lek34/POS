...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2023 at 05:26 AM
...
(5, 1, '111-1', 'BANK BCA', '2', 0, 1183333, 'Y'),
...
(2, 'pipa', 100000, 1, 100, 'Kg', 'gram', 38873, 'Y');
...
(6, 'CM/2308/0001', 1, 'lainnya', '1', 5, '2030-08-23', 111111, 'tahu', 'Y', ''),
(7, 'CM/2309/0001', 0, 'customer', '1', 5, '2005-09-23', 111111, '', 'Y', ''),
(8, 'CM/2309/0001', 1, 'lainnya', 'Deni', 5, '2005-09-23', 111111, '', 'Y', '');
...
(7, 5, NULL, NULL, 6, 0, 0, 111111, '2023-08-30'),
(8, 5, NULL, NULL, 7, 0, 0, 111111, '2023-09-05'),
(9, 5, NULL, NULL, 8, 0, 0, 111111, '2023-09-05');
...
--
ALTER TABLE `cash_masuk`
  MODIFY `id_cmasuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `history_cash_masuk`
  MODIFY `id_hcm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
